...
;Variables
  ...
  !define PRODUCT_NAME "ElectrumNavCoin"
  !define PRODUCT_WEB_SITE "https://github.com/navcoindev/electrum-navcoin"
  !define PRODUCT_PUBLISHER "NavCoin Foundation"
...
Section
  ...
  ;Links navcoin: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\navcoin" "" "URL:navcoin Protocol"
  WriteRegStr HKCU "Software\Classes\navcoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\navcoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\navcoin\shell\open\command" "" "$\"$INSTDIR\electrum.exe$\" $\"%1$\""
